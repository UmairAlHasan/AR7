...
, function(t, e, n) {
    ...
    function E(t, e) {
        var n = T(x, e, t);
        return n.code = (t && t instanceof S && t.code || 0) + e,
        n
    }
    function A(t) {
        var e = t.name
...
, function(t, e, n) {
    ...
    var r, i = n(2), o = n(41), u = n.n(o), a = u.a.clear;
    function c(t, e, n, r) {
        n = n || "all-players";
        var i = "";
        if ("object" == typeof e) {
...
, function(t, e, n) {
    ...
    var r = n(10)
      , i = n(0);
    function o(t, e) {
        if (e && Object(r.exists)(e) || (e = document.location.href),
        !Object(r.exists)(t))
            return "";
        if (u(t))
            return t;
    ...
    function l(t, e) {
        if (Object(i.u)(t) && (t = parseInt(t.toString())),
        Object(i.u)(t) || !isFinite(t) || t <= 0 && !e)
            return "00:00";
        var n = t < 0 ? "-" : "";
        t = Math.abs(t);
...
, function(t, e, n) {
    ...
    var r = n(29)
      ...
      , u = function() {
        var t = "//ssl.p.jwpcdn.com/player/v/8.21.1/";
...
, function(t, e, n) {
    ...
    var r = n(1)
        ...
        this.load = function(t, e, n, o) {
            return n && "object" == typeof n ? Promise.all(Object.keys(n).filter((function(t) {
                ...
                return e.setupPlugin(u).then((function(e) {
                    ...
                    t.code ? t : new r.q(null,Object(i.b)(u),t)
                }
                ))
            }
            ))) : Promise.resolve()
      ...
      , s = function() {
        ...
        return e.setupPlugin = function(t) {
            ...
            return e ? (e.url !== t && Object(a.a)('JW Plugin "' + Object(i.c)(t) + '" already loaded from "' + e.url + '". Ignoring "' + t + '."'),
    ...
    function d(t, e) {
        var n = t.get("plugins");
        return window.jwplayerPluginJsonp = f,
...
, function(t, e, n) {
    ...
    var r = "8.21.1+commercial_v8-21-1.468.commercial.d00f7e2.hlsjs..hlsjsalt..jwplayer.7325f8e.dai.1f98a0b.freewheel.1f60863.googima.1281534.googimanvmp.106f6b4.headerbidding.ed9ac5e.vast.5594430.analytics.920ae01.gapro.141397a"
}
, function(t, e, n) {
    "use strict";
    var r = n(0)
...
, function(t, e, n) {
    ...
    var s, l, f = "ontouchstart"in window, d = "PointerEvent"in window && !r.OS.android, p = !(d || f && r.OS.mobile), h = r.Features.passiveEvents, v = !!h && {
        passive: !0
    }, g = function(t) {
        var e, n;
        function r(e, n) {
        ...
        return i.on = function(e, n, r) {
            return b(e) && (this.handlers[e] || O[e](this)),
                ...
                !function(t) {
                    ...
                    if (!t.directSelect || c === e) {
                        ...
                        "pointerdown" === s && i.isPrimary) {
                            ...
                            C(t, "window", "pointermove", o, r),
                            C(t, "window", "pointercancel", u),
                            C(t, "window", "pointerup", u)
                        } else
                            "mousedown" === s ? (C(t, "window", "mousemove", o, r),
                            C(t, "window", "mouseup", u)) : "touchstart" === s && (C(t, "window", "touchmove", o, r),
                            C(t, "window", "touchcancel", u),
                            C(t, "window", "touchend", u))
                    }
                }
            }
            ), r),
            l || (l = new g(document).on("interaction"))
        }
    }
    function j(t) {
        if (!t.handlers.select) {
            var e = t.el;
            w(t, "select"),
            A(t, "select", (function(n) {
                var r = n.target;
                t.directSelect && r !== e || (n.isPrimary && "BUTTON" === r.tageName && r.focus(),
            ...
            C(t, "select", "click", (function(n) {
                t.directSelect && n.target !== e || (Object(u.a)() - t.lastStart > 500 && !0 === t.clicking || (function(t, e) {
                    t.enableDoubleClick && (Object(u.a)() - t.lastClick < 300 ? (T(t, i.r, e),
                    t.lastClick = 0) : t.lastClick = Object(u.a)())
                }(t, n),
                T(t, i.o, n)),
                t.clicking = !1)
            }
    ...
    var O = {
        ...
        longPress: function(t) {
            if (r.OS.iOS) {
                ...
                C(t, "longPress", "touchmove", e),
                C(t, "longPress", "touchcancel", e),
                C(t, "longPress", "touchend", e)
            } else
                t.el.oncontextmenu = function(e) {
                    return T(t, "longPress", e),
                    !1
                }
        },
        focus: function(t) {
            ...
            if (d) {
                ...
                C(t, i.Y, "pointerout", (function(n) {
                    if ("touch" !== n.pointerType && "clientX"in n) {
                        ...
                        e.contains(r) || T(t, i.Y, n)
                    }
                }
                ))
            } else
                p && C(t, i.Y, "mouseout", (function(e) {
                    T(t, i.Y, e)
                }
                ))
        },
        ...
        gesture: function(t) {
            ...
            C(t, "gesture", "click", e),
            C(t, "gesture", "keydown", e)
        },
        interaction: function(t) {
            var e = function(e) {
                t.event = e
            };
            C(t, "interaction", "mousedown", e, !0),
            C(t, "interaction", "keydown", e, !0)
        },
        tap: function() {},
        doubleTap: function() {}
    };
    ...
    function A(t, e, n, r) {
        d ? C(t, e, "pointerdown", n, r) : (p && C(t, e, "mousedown", n, r),
        C(t, e, "touchstart", n, r))
    }
}
, function(t, e, n) {
    "use strict";
    ...
    var a = function t(e, n) {
        for (var a = [], c = 0; c < Object(r.c)(e); c++) {
            ...
            if ("media" === s.prefix) {
                ...
                case "content":
                    if (Object(i.j)(s, "duration") && (n.duration = Object(i.g)(Object(i.j)(s, "duration"))),
                    Object(i.j)(s, "url")) {
                        n.sources || (n.sources = []);
                        var l = {
                ...
                case "subtitle":
                    ...
                    Object(i.j)(s, "lang").length > 0 && (d.label = o(Object(i.j)(s, "lang"))),
                    a.push(d)
                }
            }
        }
      ...
      , s = function(t, e) {
        for (var n = "default", o = [], u = [], a = e, s = 0; s < t.childNodes.length; s++) {
            ...
            if ("jwplayer" === l.prefix) {
                var f = Object(r.b)(l);
                "source" === f ? (delete e.sources,
                o.push({
                    file: Object(i.j)(l, "file"),
                    default: Object(i.j)(l, n),
                    label: Object(i.j)(l, "label"),
                    type: Object(i.j)(l, "type")
                })) : "track" === f ? (delete e.tracks,
                u.push({
                    file: Object(i.j)(l, "file"),
                    default: Object(i.j)(l, n),
                    kind: Object(i.j)(l, "kind"),
                    label: Object(i.j)(l, "label")
                })) : (e[f] = Object(c.serialize)(Object(r.d)(l)),
                "file" === f && e.sources && delete e.sources)
            }
        ...
        if (o.length) {
            ...
            for (var d = 0; d < o.length; d++) {
                var p = o[d];
                p.file.length > 0 && (p[n] = "true" === o[d][n],
                p.label || delete p.label,
                a.sources.push(p))
            }
        }
        if (u.length) {
            ...
            for (var h = 0; h < u.length; h++) {
                var v = u[h];
                v.file && v.file.length > 0 && (v[n] = "true" === u[h][n],
                v.kind = u[h].kind.length ? u[h].kind : "captions",
...
, function(t, e, n) {
    ...
    e.b = function(t, e) {
        ...
        var j = v.playlist;
        if (j)
            Array.isArray(j.playlist) && (v.feedData = j,
            v.playlist = j.playlist);
        else {
        ...
        delete v.duration;
        var O = v.liveTimeout;
        null !== O && (Object(r.z)(O) ? 0 !== O && (O = Math.max(30, O)) : O = null,
        v.liveTimeout = O);
        var k, C, P = parseFloat(v.bandwidthEstimate), x = parseFloat(v.bitrateSelection);
        return v.bandwidthEstimate = Object(r.z)(P) ? P : (k = v.defaultBandwidthEstimate,
        C = parseFloat(k),
        Object(r.z)(C) ? Math.max(C, 1) : l.bandwidthEstimate),
        v.bitrateSelection = Object(r.z)(x) ? x : l.bitrateSelection,
...
, function(t, e, n) {
    ...
    var I = function(t) {
        var e, n;
        if (t ? "string" == typeof t ? (e = M(t)) || (n = document.getElementById(t)) : "number" == typeof t ? e = v.a[t] : t.nodeType && (e = M((n = t).id || n.getAttribute("data-jwplayer-id"))) : e = v.a[0],
        e)
            return e;
        if (n) {
            var r = new F(n);
    ...
    U.utils.css.style = U.utils.style,
    U.vid = V.a;
    var Q = U
      , W = n(63)
      , X = /^(?:on(?:ce)?|off|trigger)$/;
    ...
    function Z(t, e) {
        var n = {
            reason: !("play" === t || "seek" === t || "pause" === t) && Object(W.a)() ? "interaction" : "external"
        };
        switch (t) {
        case "play":
        case "pause":
    ...
    Object(r.j)(l.prototype, {
        ...
        getNewInstance: function(t, e, n) {
            ...
            if ("function" != typeof r)
                throw new a.q(null,Object(c.b)(this.url) + 100);
            var i = new r(t,e,n);
...
, function(t, e, n) {
    ...
    e.a = function() {
            ...
            try {
                ...
                if (c) {
                    for (var f = 0; f < c.length && 8 === (l = c[f]).nodeType; f++)
                        ;
                    if (l && "xml" === Object(o.b)(l) && (l = l.nextSibling),
                    l && "rss" === Object(o.b)(l)) {
                        var d = Object(u.a)(l);
                        a = Object(r.j)({
                            playlist: d
        ...
        function n(e) {
            e instanceof s.q && !e.code && (e = new s.q(s.m,0)),
            t.trigger(i.w, e)
        }
...
, function(t, e, n) {
    ...
    function m(t, e) {
        var n = "file:" === window.location.protocol ? "https:" : ""
          , r = {
            bidding: "//ssl.p.jwpcdn.com/player/v/8.21.1/bidding.js",
            jwpsrv: "//ssl.p.jwpcdn.com/player/v/8.21.1/jwpsrv.js",
            dai: "//ssl.p.jwpcdn.com/player/plugins/dai/v/0.5.3/dai.js",
            vast: "//ssl.p.jwpcdn.com/player/plugins/vast/v/8.9.5/vast.js",
            googima: e ? "//ssl.p.jwpcdn.com/player/v/8.21.1/googimanvmp.js" : "//ssl.p.jwpcdn.com/player/plugins/googima/v/8.9.0/googima.js",
    ...
    var y = function(t, e) {
        var i, d, y, j = Object(o.b)(t, e), w = j.key || c.default.key, O = new s.b(w), k = O.edition();
        ...
        }, o.a, Object(r.C)(j, ["analytics", "aspectratio", "base", "file", "height", "playlist", "sources", "width"]))),
        j.key = w,
        j.edition = k,
        j.error = O.error(),
        ...
        i = j.playlist,
        Object(r.x)(i) && i.indexOf("__CONTEXTUAL__") > -1 && (j.playlist = function(t, e) {
        ...
        Object(a.isFileProtocol)()) {
            var P = j
              ...
              , S = P.related;
            v(x) && (j.playlist = g(x)),
            S && v(S.file) && (S.file = g(S.file))
        }
        return j.__abSendDomainToFeeds && (y = j.playlist,
        /\.jwplatform.com|\.jwplayer.com/.test(y)) && (j.playlist = (d = j.playlist,
        d += (-1 !== d.indexOf("?") ? "&" : "?") + "page_domain=" + encodeURIComponent(Object(h.a)()))),
        j
    }
      , j = n(8)
      , w = n(28)
    ...
    function E(t) {
        return T || (T = function(t) {
            ...
            if (S.OS.tizen)
                return _();
            if (e && r && i)
                return o = n.e(8).then(function(t) {
                    n(164);
                    var e = n(71).default;
                    return P.a.controls = n(69).default,
                    Object(C.a)(n(168).default),
                    e
                }
                .bind(null, n)).catch(Object(j.b)(x.s + 105)),
                j.a.html5 = o,
                o;
            var o;
            if (e && i)
    ...
    var q = n(37)
      , z = function(t, e) {
        return /isAMP/.test(document.location.search) ? n.e(1).then(function(r) {
            var i = new (0,
            n(179).default)(e);
            return t.attributes.ampController = i,
            Promise.resolve()
        }
    ...
    function V(t) {
        return Q(t) ? Promise.resolve() : R(t).then((function() {
            if (t.get("drm") || Object(q.b)(t.get("playlist")))
                return Object(q.d)(t.get("edition"))
        }
        )).then((function() {
    ...
    function H(t, e) {
        var n = [U(t), z(t, e)];
        return Q(t) || n.push(Promise.resolve()),
        Promise.all(n)
    }
    function U(t) {
        var e = t.attributes
        ...
        if (n && n.code === s.a) {
            ...
            if (i > 0 && i < 4 && r && o.duration() > -7776e6)
                return new L.a("//content.jwplatform.com/libraries/" + r + ".js").load().then((function() {
      ...
      , X = function(t) {
        ...
        return !Object(N.h)(n) || Object(N.f)(u) ? Promise.resolve() : new Promise((function(i) {
            return Object(N.i)(r, n).then((function(n) {
                ...
                if (!B(t)) {
                    if (!r)
                        throw new x.q(null,x.h);
                    e.localization = Object(N.a)(r, u),
                    i()
                }
            }
            )).catch((function(t) {
    ...
    var tt = function() {
        ...
        return e.getAllItems = function() {
            ...
            return this.items.reduce((function(e, n) {
                ...
                return r && (e[n] = "captions" !== n ? Object(K.serialize)(r) : JSON.parse(r)),
                e
            }
            ), {})
        }
    ...
    var ct = function(t) {
        ...
        this.modelShim._qoeItem = new J.a,
        this.mediaShim = {},
    ...
    function st(t, e) {
        ...
        console.error(x.q.logMessage(e.code)))
    }
    function lt(t) {
    ...
    Object(r.j)(ct.prototype, {
        ...
        init: function(t, e) {
            ...
            Object(r.j)(this.mediaShim, nt.c);
            var a = t
              , c = y(Object(r.j)({}, t), u);
            c.id = e.id,
            c.setupConfig = a,
            ...
            return i.on("change:errorEvent", st),
            this.setup.start(e).then((function(t) {
                var u = t.core;
                if (!u)
                    throw Object(x.y)(null, x.v);
                if (n.setup) {
                    n.on(I.ub, lt),
                    ...
                    n.playerSetup(a, e, n.originalContainer, n._events, c, s);
                    var l = n._model;
                    return i.off("change:errorEvent", st),
                ...
                n.setup && function(t, e, n) {
                    Promise.resolve().then((function() {
                        ...
                        if (!o) {
                            ...
                            it.a.cloneIcon && u.querySelector(".jw-icon").appendChild(it.a.cloneIcon("error")),
                            ft(t, u)
                        }
                        i.set("errorEvent", r),
                        i.set("state", I.lb),
...
, function(t, e, n) {
    "use strict";
    var r, i = n(62), o = n(5), u = n(7), a = [], c = [], s = [], l = {}, f = "screen"in window && "orientation"in window.screen, d = o.OS.android && o.Browser.chrome, p = !1;
    function h(t, e) {
